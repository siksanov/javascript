class Slider {
    ...
    #buttonMouseOver2 = evt => {
        if (this.#getButtonIndex(evt.target) == this.#activeImageIndex)
    ...
    constructor(element) {
        ...
        nav.addEventListener('mouseover', this.#buttonMouseOver2,
                                          { capture: true });
        ...
        main.addEventListener('contextmenu', this.#mainContextMenu);
